...
class BootStrap {
	...
	def init = { servletContext ->
		...
		// applicationContext.addApplicationListener(new MyPersistenceEventListener())
		...
		Game.withTransaction {
			...
			g4.save(flush:true, failOnError:true)
		...
		Player.withTransaction {tx ->
			println"***creating players"
			def  p1 = new Player(firstName:"Laurel", lastName:"Wagner", status:"active")
